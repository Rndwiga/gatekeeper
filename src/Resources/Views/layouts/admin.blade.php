            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cubes"></i> Mifos Integration<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('credit/identity/verify')}}">Manage Keys</a></li>
                      <li><a href="{{url('credit/identity/verify')}}">Metropol</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-credit-card"></i> Mobile Money<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">C2B Transactions</a></li>
                      <li><a href="#">B2C Transactions</a></li>
                      <li><a href="#">B2B Transactions</a></li>
                      <li><a href="#">Reversed Transactions</a></li>
