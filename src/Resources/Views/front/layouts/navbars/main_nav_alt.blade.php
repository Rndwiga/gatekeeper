                  ...
                  <span class="nav-icon-toggle__box">
                    <span class="nav-icon-toggle__inner"></span>
                        ...
                        <a href="{{url('/')}}" class="logo">
                            <img class="logo__img" src="{{ asset('deus') }}/img/logo_fashion.png" srcset="{{ asset('deus') }}/img/logo_fashion.png 1x, {{ asset('deus') }}/img/logo_fashion@2x.png 2x" alt="logo">
                        </a>
                    </div>
                </div>
                ...
                <div class="flex-child">
                    <div class="nav__right">
                        ...
                        <div class="nav__right-item nav__search">
                            <a href="index-fashion.html#" class="nav__search-trigger" id="nav__search-trigger">
