                ...
                <div class="col-lg-3 col-md-6">
                    <aside class="widget widget-logo">
                        ...
                        <div class="socials socials--large socials--rounded mb-24">
                            <a href="index.html#" class="social social-facebook" aria-label="facebook"><i class="ui-facebook"></i></a>
                            <a href="index.html#" class="social social-twitter" aria-label="twitter"><i class="ui-twitter"></i></a>
                            <a href="index.html#" class="social social-google-plus" aria-label="google+"><i class="ui-google"></i></a>
                            <a href="index.html#" class="social social-youtube" aria-label="youtube"><i class="ui-youtube"></i></a>
                            <a href="index.html#" class="social social-instagram" aria-label="instagram"><i class="ui-instagram"></i></a>
                        </div>
                    </aside>
                </div>
