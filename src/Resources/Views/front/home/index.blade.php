                            ...
                            <ul class="tabs__list">
                                @if(isset($categoryList))
                                   @foreach($categoryList as $category)
                                        {{--<li class="tabs__item tabs__item--active"><a href="index.html#tab-all" class="tabs__trigger">{{$category['category_id']}}</a></li>--}}
                                        <li class="tabs__item"><a href="{{route('writter.front.article')}}#tab-{{$category['category_id']}}" class="tabs__trigger">{{$category['category_id']}}</a></li>
                                   @endforeach
                                @endif
                            </ul>
                            <!-- end tabs -->
                                ...
                                @if(isset($categoryList))
                                    @foreach($categoryList as $catKey => $category)
                                        @if($key == $category['category_id'])
                                            @if($catKey == 0)
                                                <div class="tabs__content-pane tabs__content-pane--active" id="tab-{{$key}}">
                                                @else
                                                <div class="tabs__content-pane tabs__content-pane" id="tab-{{$key}}">
                                            @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <article class="entry card">
                                                            <div class="entry__img-holder card__img-holder">
                                                                <a href="{{route('writter.front.article',$item['slug'])}}">
                                                                    <div class="thumb-container thumb-70">
                                                                        <img data-src="{{$item['featured_image']}}" src="{{$item['featured_image']}}" class="entry__img lazyload" alt="" />
                                                                    </div>
                                                                </a>
                                                                <a href="{{route('writter.front.article',$item['slug'])}}" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--violet">{{$item['category_id']}}</a>
                                                            </div>
                                                            ...
                                                            <div class="entry__body card__body">
                                                                <div class="entry__header">
                                                                    ...
                                                                    <h2 class="entry__title">
                                                                        <a href="{{route('writter.front.article',$item['slug'])}}"></a>
                                                                    </h2>
                                                                    <ul class="entry__meta">
                                                                        <li class="entry__meta-author">
                                                                            <span>by</span>
                                                                            <a href="{{route('writter.front.article',$item['slug'])}}">DeoThemes</a>
                                                                        </li>
                            ...
                            <article class="post-list-small__entry clearfix">
                                ...
                                <div class="post-list-small__body">
                                    <h3 class="post-list-small__entry-title">
                                        <a href="{{route('writter.front.article',$item['slug'])}}">{{$item['title']}}</a>
                                    </h3>
                                    <ul class="entry__meta">
                                        <li class="entry__meta-author">
                                            <span>by</span>
