            ...
            <div class="col-lg-8 blog__content mb-72">
                <div class="content-box content-box--top-offset">
                    ...
                    <article class="entry mb-0">
                        ...
                        <div id="respond" class="comment-respond">
                            <div class="title-wrap">
                                <h5 class="comment-respond__title section-title">Quote Details</h5>
                            </div>
                            <form id="form" class="comment-form" method="post" action="{{ url('add-to-cart/'.$post['id']) }}">
                                @csrf
                                <div class="row row-20">
                                    <div class="col-lg-6">
                                        <label for="comment">Writer Experience: *</label>
                                        <select name="experience">
                                            <option>Pro</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="comment">Subject Matter:</label>
                                        <select name="subject_matter">
                                ...
                                <div class="row row-20">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input name="item_quantity" id="quantity" type="number">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="unit_price">Unit Price ($):</label>
                                        <input name="unit_price" id="unit_price" type="text" value="{{$post['price']}}" disabled>
                                    </div>
                                </div>
                                <p class="comment-form-comment">
                                    <label for="comment">Additional Instructions</label>
                                    <textarea id="comment" name="additional_instructions" rows="5" required="required"></textarea>
                                </p>

                                <p class="comment-form-submit">
                                    <input type="submit" class="btn btn-lg btn-color btn-button" value="Add to Cart">
                                </p>
            ...
            <aside class="col-lg-4 sidebar sidebar--right">
                ...
                <div class="row">
                    ...
                    <aside class="widget widget-popular-posts">
                        <h4 class="widget-title">Order Cart</h4>
                                        ...
                                        <article class="post-list-small__entry clearfix">
                                            <div class="post-list-small__img-holder">
                                                <div class="thumb-container thumb-100">
                                                    <a href="{{route(Request::route()->getName(),$details['slug'])}}">
                                                        <img data-src="{{$details['featured_image']}}" src="{{$details['featured_image']}}" alt="" class="post-list-small__img--rounded lazyload">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="post-list-small__body">
                                                <h3 class="post-list-small__entry-title">
                                                    <a href="{{route(Request::route()->getName(),$details['slug'])}}">{{$details['name']}}</a>
                                                </h3>
                                                <ul class="entry__meta">
                                                    <li class="entry__meta-author">
                                                        <span>Quantity</span>
                        ...
                        <div class="row total-header-section"></div>
                        <div class="row total-header-section">
                            ...
                            <div class="col-lg-6 col-sm-6 col-6 total-section text-right">
                                <a href="{{ url('order/list') }}" class="btn btn-primary btn-block" style="background-color: white; color: #0b0b0b; text-align: center">View Cart ($ {{$total}})</a>
                            </div>
                        </div>
